...
}:
{
  ...
  kernelsu-main = {
    pname = "kernelsu-main";
    version = "28fedfa1b3e739c1fb5da44309f32ecc99e85d26";
    src = fetchgit {
      url = "https://github.com/tiann/KernelSU.git";
      rev = "28fedfa1b3e739c1fb5da44309f32ecc99e85d26";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-nvG8P2sPtiNrfy7p861cLE5RjhiEAhMbmpyaIxSbLSk=";
    };
    date = "2026-03-01";
  };
  ...
  susfs-android14-5_15 = {
    ...
    version = "b29f225418402e0b2a626303561ecd3a472b7b6f";
    src = fetchgit {
      url = "https://gitlab.com/simonpunk/susfs4ksu.git";
      rev = "b29f225418402e0b2a626303561ecd3a472b7b6f";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-k2ymS06oKrL1YKuEy2/DbdYT7QnCBTMfymMeSg/cMKY=";
    };
    date = "2026-03-01";
  };
  wildplus-kernel-patches = {
    pname = "wildplus-kernel-patches";
    version = "194957c3bca214dc111c503bb09dc66007ab59d4";
    src = fetchFromGitHub {
      owner = "WildPlusKernel";
      repo = "kernel_patches";
      rev = "194957c3bca214dc111c503bb09dc66007ab59d4";
      fetchSubmodules = false;
      sha256 = "sha256-YJ1WBZXgTEt/gK5btgw5iI9zxOrbLDPWgG4Bn52whVg=";
    };
    date = "2026-03-01";
  };
}
