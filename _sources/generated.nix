...
}:
{
  ...
  susfs-android14-5_15 = {
    ...
    version = "e1b1bba04b3cada700b8fd5bda4cfd4c59de07a2";
    src = fetchgit {
      url = "https://gitlab.com/simonpunk/susfs4ksu.git";
      rev = "e1b1bba04b3cada700b8fd5bda4cfd4c59de07a2";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-j6JPtWg7Bw5lbS4Q4kkh8uBJFAT16k5/AP2gmb5A1ug=";
    };
    date = "2025-10-14";
  };
  wildplus-kernel-patches = {
    pname = "wildplus-kernel-patches";
    version = "e68873ca84eb5216c2519cda41de4eec4b70c93a";
    src = fetchFromGitHub {
      owner = "WildPlusKernel";
      repo = "kernel_patches";
      rev = "e68873ca84eb5216c2519cda41de4eec4b70c93a";
      fetchSubmodules = false;
      sha256 = "sha256-4ERm2CnFabdrnorObCzX6EE4f287byR3j29isdxrc8Q=";
    };
    date = "2025-10-14";
  };
}
